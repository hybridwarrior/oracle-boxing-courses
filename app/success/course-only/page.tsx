...
function CourseOnlySuccessContent() {
  useEffect(() => {
    (async function () {
      const cal = await getCalApi({"namespace":"course-onboarding-call"});
        ...
        <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="mb-6 sm:mb-8">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black mb-4 sm:mb-6">
              Next Step: Book Your Course Onboarding Call
            </h1>
            <p className="text-sm sm:text-base lg:text-lg text-black leading-relaxed">
              This is your consultation call where we'll look at your technique and teach you how best to use the course.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden" style={{minHeight: '600px'}}>
            <Cal
              namespace="course-onboarding-call"
              calLink="team/oracle-boxing/course-onboarding-call"
...
export default function CourseOnlySuccessPage() {
  return (
    <Suspense fallback={
