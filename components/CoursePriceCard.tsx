    ...
    <section className="py-8 sm:py-20 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#26304a] rounded-2xl sm:rounded-3xl p-6 sm:p-16 shadow-2xl text-white">
          ...
          {/* Heading */}
          <h3 className="text-xl sm:text-3xl md:text-4xl font-medium text-center mb-4 sm:mb-6 lg:mb-8 uppercase" style={{ fontFamily: "var(--font-satoshi)" }}>
            {getCourseHeading()}
          </h3>
          ...
          <div className="text-center mb-4 sm:mb-6 lg:mb-8">
            {bundleCrossedPrice && (
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold opacity-60 line-through mb-1 sm:mb-2">
            ...
            {product.recurring && (
              <div className="text-base sm:text-lg md:text-xl font-bold opacity-90">per {product.interval}</div>
            )}
