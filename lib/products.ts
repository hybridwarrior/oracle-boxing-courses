...
export const products: Product[] = [
  {
    ...
    type: 'course',
    metadata: 'obm',
    stripe_product_id: process.env.STRIPE_PRODUCT_BUNDLE || 'prod_THsui65fQm9N6o',
    stripe_price_id: process.env.STRIPE_PRICE_BUNDLE || 'price_1SLLSAQNEdHwdojXPF01j36I',
...
Complete access to the entire Oracle Boxing system — theory, technique, and tactics.`,
  },
  {
    ...
    type: 'course',
    metadata: 'bffp',
    stripe_product_id: process.env.STRIPE_PRODUCT_BFFP || 'prod_THsl9Np6lVlAPp',
    stripe_price_id: process.env.STRIPE_PRICE_BFFP || 'price_1SLLMGQNEdHwdojXcJB9yqAt',
...
Develop discipline, leadership, and long-term mastery mindset.`,
  },
  {
    ...
    type: 'course',
    metadata: 'brdmp',
    stripe_product_id: process.env.STRIPE_PRODUCT_ROADMAP || 'prod_THsnVY468QZZqW',
    stripe_price_id: process.env.STRIPE_PRICE_ROADMAP || 'price_1SLLNdQNEdHwdojXYN9j0mFy',
...
Master every aspect of boxing technique through structured progression.`,
  ...
  // MEMBERSHIPS
  {
    ...
    recurring: true,
    interval: '3 months',
    stripe_product_id: process.env.STRIPE_PRODUCT_MEMBERSHIP || 'prod_THsviAkmOBiKx4',
    stripe_price_id: process.env.STRIPE_PRICE_MEMBERSHIP_QUARTERLY || 'price_1SNDkHQNEdHwdojX5AJH1EGu',
    price_ids: {
      multicurrency: process.env.STRIPE_PRICE_MEMBERSHIP_QUARTERLY || 'price_1SNDkHQNEdHwdojX5AJH1EGu',
    },
...
Transform your boxing with ongoing expert guidance.`,
  ...
  },
  {
    ...
    interval: '6 months',
    stripe_product_id: process.env.STRIPE_PRODUCT_MEMBERSHIP || 'prod_THsviAkmOBiKx4',
    stripe_price_id: process.env.STRIPE_PRICE_MEMBERSHIP_6MONTH || 'price_1SNDlmQNEdHwdojX9U3X8M3l',
    price_ids: {
      multicurrency: process.env.STRIPE_PRICE_MEMBERSHIP_6MONTH || 'price_1SNDlmQNEdHwdojX9U3X8M3l',
    },
    image: 'https://media.oracleboxing.com/Website/optimized/products/boxing_clinic-large.webp',
...
Best for dedicated students ready to transform their boxing.`,
  ...
  },
  {
    ...
    interval: 'year',
    stripe_product_id: process.env.STRIPE_PRODUCT_MEMBERSHIP || 'prod_THsviAkmOBiKx4',
    stripe_price_id: process.env.STRIPE_PRICE_MEMBERSHIP_ANNUAL || 'price_1SNDn8QNEdHwdojXOipfd9MG',
    price_ids: {
      multicurrency: process.env.STRIPE_PRICE_MEMBERSHIP_ANNUAL || 'price_1SNDn8QNEdHwdojXOipfd9MG',
    },
    image: 'https://media.oracleboxing.com/Website/optimized/products/boxing_clinic-large.webp',
...
const internalProducts: Product[] = [
  {
    ...
    type: 'course',
    metadata: '6wc',
    stripe_product_id: process.env.STRIPE_PRODUCT_6WC || 'prod_THsxtrkuzFgwk6',
    stripe_price_id: process.env.STRIPE_PRICE_6WC || 'price_1SLLGdQNEdHwdojXuQpghdfH',
...
Perfect for beginners or boxers who want rapid improvement with accountability.`,
  ...
  },
  {
    ...
    type: 'course',
    metadata: 'rcv',
    stripe_product_id: process.env.STRIPE_PRODUCT_VAULT || 'prod_THtRqY17sSwQJJ',
    stripe_price_id: process.env.STRIPE_PRICE_VAULT || 'price_1SLLIKQNEdHwdojXkxUeIDwA',
    image: 'https://media.oracleboxing.com/Website/optimized/products/boxing_clinic-large.webp',
  ...
  },
  {
    ...
    type: 'course',
    metadata: 'ltbffp',
    stripe_product_id: process.env.STRIPE_PRODUCT_LIFETIME_BFFP || 'prod_THtTT54jtb1l9c',
    stripe_price_id: process.env.STRIPE_PRICE_LIFETIME_BFFP || 'price_1SLLJlQNEdHwdojXKgVggogM',
    image: 'https://media.oracleboxing.com/Website/optimized/products/bffp_tn5-large.webp',
